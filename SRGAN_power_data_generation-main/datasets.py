...
def get_evaluation_data(data_type, resolution, evaluation_data_file_name, FILENAME):
    # read normalised data in npy
    norm_evaluation_data = np.load(data_dir + FILENAME + evaluation_data_file_name + '_%s_%s.npy' % (data_type, resolution))
